...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/HPGrowingTextView-framework/HPGrowingTextView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MLLabel-framework/MLLabel.framework"
fi
